...
SHEET_ID         = "1UZ9qa1KkHuXdYp6ogGhYYGut0yvHWSEi_KPInRHsKno"
TEMPLATE_FILE    = "dashboard_lancamento_gratuito.html"
OUTPUT_FILE      = "index.html"

NOME_CLIENTE     = "Escuela eINES"
LOGO_LETRA       = "EI"
COR_ACENTO       = "#B8860B"
...
CPV_MEDIO        = 150.0
CPL_BOM          = 18.56   # (mantido p/ retrocompat, não usado no foco vendas)
CPL_MEDIO        = 21.84
...
def load_meta():
    ...
    for c in ["spend","impressions","link_clicks","page_view","leads_native","checkout","purchases","purchase_value"]:
    ...
    df["leads"] = df["leads_native"]   # Orlando/eINES: só Action Leads tem dados
